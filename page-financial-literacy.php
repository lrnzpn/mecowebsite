<?php
/**
* Template Name: Financial Literacy
 */
?>
<?php get_header(); ?>

<script>$('div.main-header').css("background-color","rgba(0,29,48,1)")</script>
<?php $custom_query = new WP_Query( array( 'category_name' => 'financial-literacy' )); ?>
...
<input name="back" type="hidden" value="Financial Literacy">
<input name="url" type="hidden" value="http://ateneomeco.com/financial-literacy/">
...
while($custom_query->have_posts()) : $custom_query->the_post(); ?>
	...
	the_post_thumbnail();
		...
		<div class="col-md-8 newsletterListTextDiv" id="newsletterListTextDiv1">
			<div id="newsletterListInfo">Financial Literacy<span id="division"> | </span><?php the_date(); ?></div><br />
			<div id="newsletterListTitle">
				<?php the_title(); ?>
