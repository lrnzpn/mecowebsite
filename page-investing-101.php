...
<?php $custom_query = new WP_Query( array( 'category_name' => 'investing-101' )); ?>
...
<input name="back" type="hidden" value="Investing 101">
<input name="url" type="hidden" value="http://ateneomeco.com/investing101/">
...
while($custom_query->have_posts()) : $custom_query->the_post(); ?>
	...
	the_post_thumbnail();
		...
		<div class="col-md-8 newsletterListTextDiv" id="newsletterListTextDiv1">
			<div id="newsletterListInfo">Investing 101<span id="division"> | </span><?php the_date(); ?></div><br />
