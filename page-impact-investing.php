<?php
/**
* Template Name: Impact Investing
 */
?>
...
<?php $custom_query = new WP_Query( array( 'category_name' => 'impact-investing' )); ?>
...
<input name="back" type="hidden" value="Impact Investing">
<input name="url" type="hidden" value="http://ateneomeco.com/impact-investing/">
