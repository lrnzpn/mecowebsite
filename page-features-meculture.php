<?php
/**
* Template Name: Features-Meculture
*/
?>
...
<?php $custom_query = new WP_Query( array( 'category_name' => 'features' )); ?>
...
<input name="back" type="hidden" value="Features">
<input name="url" type="hidden" value="http://ateneomeco.com/features/">
...
while($custom_query->have_posts()) : $custom_query->the_post(); ?>
	...
	the_post_thumbnail();
		...
		<div class="col-md-8 newsletterListTextDiv" id="newsletterListTextDiv1">
			<div id="newsletterListInfo">Features<span id="division"> | </span><?php the_date(); ?></div><br />
